...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        menuBar->setGeometry(QRect(0, 0, 923, 29));
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actAbout->setText(QCoreApplication::translate("QWMainWind", "\345\267\245\345\205\267", nullptr));
#if QT_CONFIG(tooltip)
        actAbout->setToolTip(QCoreApplication::translate("QWMainWind", "\346\211\223\345\274\200about\347\252\227\345\217\243", nullptr));
#endif // QT_CONFIG(tooltip)
